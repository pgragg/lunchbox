...
date = Date.today#menus[0].lunch_date_list[0]
...
Summary.create!(date: date, name: "DWT Staff (list)")
...
if Year.count == 0 
  year = Year.create!(start_date: Date.today, end_date: (Date.today + 364))
  year.trimesters.create!(start_date: Date.today, end_date: Date.today+90)
  year.trimesters.create!(start_date: Date.today+ 91, end_date: Date.today+180)
  year.trimesters.create!(start_date: Date.today+ 181, end_date: Date.today+364)
end 
